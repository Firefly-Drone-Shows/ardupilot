...
#include <AC_WPNav/AC_Dance.h>           // dance navigation library
...
#include <AP_GPS/AP_RTCM_Counter.h>
...
# include USERHOOK_VARIABLES
    ...
    float dance_takeoff_alt;
    float dance_alt_delta;
 ...
 #define MOTOR_CLASS AP_MotorsMulticopter
    ...
    // Dance
    DanceMode dance_mode; // control which dance controller is run
    ...
    // Counter for rtcm package loss
    RTCM_Counter rtcm_counter {gps};
    ...
    void send_dance_status(mavlink_channel_t chan);
    void send_dance_additional_status(mavlink_channel_t chan);
    void send_dance_target_position(mavlink_channel_t chan);
    
    void send_dance_msg_92(mavlink_channel_t chan);
    void send_dance_msg_93(mavlink_channel_t chan);
    void send_dance_msg_94(mavlink_channel_t chan);
    void send_dance_msg_95(mavlink_channel_t chan);
    uint64_t dance_main_telemetry_count[MAVLINK_COMM_NUM_BUFFERS];
    uint64_t dance_preflight_telemetry_count[MAVLINK_COMM_NUM_BUFFERS];
    ...
    bool dance_init(bool ignore_checks);
    void dance_run();
    void dance_dance_run();
    void dance_takeoff_start();
    void dance_takeoff_run();
    void dance_land_run();
