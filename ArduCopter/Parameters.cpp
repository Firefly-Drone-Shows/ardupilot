...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Param: AUX_FREQ
    // @DisplayName: aux out frequency 
    // @Description: 
    // @Units: Hz
    // @Range: 50 1000
    // @User: Advanced
    GSCALAR(aux_freq, "AUX_FREQ",                1000),
    ...
    // @Group: DANCE_
    // @Path: ../libraries/AC_WPNav/AC_Dance.cpp
    GOBJECTPTR(dance_nav, "DANCE_",  AC_Dance),

    // @Group: DLED_
    // @Path: ../libraries/AC_Dancing_LED/AC_Dancing_LED.cpp
    GOBJECTPTR(dancing_led, "DLED_",  AC_Dancing_LED),
