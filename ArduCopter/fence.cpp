...
void Copter::fence_check()
{
    ...
    // Hard fence check
    if (fence.hard_fence_enabled() && fence.hard_fence_breach()) {
        GCS_MAVLINK::send_statustext_all(MAV_SEVERITY_CRITICAL, "MAYDAY MAYDAY! Out of Hard Fence. Shutdown engaged!");
