...
public:
    ...
    void send_heartbeat_as_data16(uint8_t type, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, 
...
protected:
    ...
    void handle_gps_inject(mavlink_channel_t rtcm_chan, const mavlink_message_t *msg, AP_GPS &gps);
