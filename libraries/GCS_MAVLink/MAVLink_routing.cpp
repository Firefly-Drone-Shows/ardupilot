...
*/
bool MAVLink_routing::check_and_forward(mavlink_channel_t in_channel, const mavlink_message_t* msg, const bool enable_forwarding = 0)
{
    ...
    //if (!enable_forwarding) {
        // nothing more to do - we disable forwarding
        // by parameter SR*_FRWD_ENABLE
        // return process_locally;
    //}

    // forward on any channels matching the targets
    bool forwarded = false;
    // We disable forwarding by parameter SR*_FRWD_ENABLE
    if (enable_forwarding) {
